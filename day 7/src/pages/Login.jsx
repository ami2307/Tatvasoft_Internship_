...
function Login() {
    ...
    return (
        <>
            {/* <Header /> */}
            <h2 style={{ textAlign: 'center', color: '#78faff', backgroundColor: '#2b3030', borderRadius:'15px', margin:'10px', padding:'5px' }}>Login or Create an Account</h2>
            <div className="log_maindiv">
                <div className="log_subdiv1">
                    ...
                    <Button variant="contained" style={{ background: '#4f92f7' }}>Create an Account</Button>
                </div>
                <div className="log_subdiv2">
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <label>Password*<br />
                        <TextField name="password" type="password" value={formik.values.password} onChange={formik.handleChange} onBlur={formik.handleBlur} size="small"></TextField>
                        {formik.errors.password && formik.touched.password ? <div className="reg_err">{formik.errors.password}</div> : null}
                        </label><br/><br/>
                        <Button variant="contained" size="small" style={{ background: '#4f92f7' }} type="submit">Login</Button>
                        <p style={{color:'#2c16f2', cursor:'pointer'}}>Forgate Password ?</p>
                    </form>
                </div>
            </div>
