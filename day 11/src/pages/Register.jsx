    ...
    return (
        <>
            ...
            <div className="reg_full_form">
                <h2 style={{ textAlign: 'center', color: '#78faff', backgroundColor: '#464047', borderRadius:'15px', margin:'10px', padding:'5px' }}>Register or Create an Account</h2>
                <form onSubmit={formik.handleSubmit} >
                    ...
                    <div className="reg_single_row">
                        <div className="reg_single_column">
                            <label>Password:<br />
                                ...
                                <TextField size="small" type="password" name="password" value={formik.values.password} onChange={formik.handleChange} onBlur={formik.handleBlur}></TextField>
                        ...
                        <div className="reg_single_column">
                            <label>Confirm Password:<br />
                                ...
                                <TextField size="small" type="password" name="confirm_password" value={formik.values.confirm_password} onChange={formik.handleChange} onBlur={formik.handleBlur}></TextField>
                    ...
                    {/* <input type="submit" /> */}
                    <br />
                    <Button variant="contained" size="small" style={{ background: '#2c16f2' }} type="submit">Register</Button>
                </form>
